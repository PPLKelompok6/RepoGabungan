...
<style>
    ...
    .developer-image {
        ...
        <div class="testimonials-section py-5">
            <div class="container">
                <div class="text-center mb-5">
                    <h2 class="section-title">Testimonial Pengguna</h2>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="testimonial-card mb-4">
                            <div class="testimonial-content text-center">
                                <img src="{{ asset('images/default-avatar.png') }}" alt="User Avatar" class="testimonial-avatar mb-3">
                                <h5 class="user-name mb-2">{{ $feedback->user->name }}</h5>
