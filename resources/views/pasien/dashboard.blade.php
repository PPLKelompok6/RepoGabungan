        ...
        <div class="col-md-6">
            <div class="card h-100 shadow-sm">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-1">Chat Dokter</h5>
                        <p class="card-text text-muted mb-2">Konsultasi langsung dengan dokter melalui fitur chat</p>
                ...
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('mental-health.test', ['type' => 'burnout']) }}" class="btn btn-warning">Mulai Tes</a>
