...
class MentalHealthTestNegatif extends DuskTestCase
{
    /**
     * A Dusk test example.
     * @group test4
    ...
    public function testExample(): void
    {
        $this->browse(function (Browser $browser) {
            $browser->visit('/login')
                ...
                // Mengisi form biodata dengan field domisili dan pekerjaan kosong
                ->waitForText('Tes Psikologi Burnout')
                ->type('usia', '22')
                ->select('gender', 'Laki-laki')
                // Sengaja mengosongkan domisili dan pekerjaan
